...
const emojiTemplate = (unicode, category) => (
  `<img class="mindmap-emoji" title="${category}" src="https://github.com/images/icons/emoji/unicode/${unicode}.png">`
)

const customEmojiTemplate = (emoji, category) => (
  `<img class="mindmap-emoji" title="${category}" src="https://github.com/images/icons/emoji/${emoji}.png">`
)
